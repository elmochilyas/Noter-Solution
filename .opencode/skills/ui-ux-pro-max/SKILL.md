...
| React Native | `web` | `--domain web "accessibilityLabel touch safe-areas"` |
...
```bash
python3 .opencode/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <stack-name>
```

Available stacks: `react`, `nextjs`, `vue`, `nuxtjs`, `nuxt-ui`, `svelte`, `astro`, `angular`, `laravel`, `html-tailwind`, `shadcn`, `swiftui`, `jetpack-compose`, `react-native`, `flutter`, `threejs`
...
| `nextjs` | App Router, RSC, Server Actions, Meta |
| `vue` | Composition API, Transitions, Slots |
| `nuxtjs` | Auto-imports, Pages, Layouts, Fetching |
| `nuxt-ui` | Nuxt UI components, Theming |
| `svelte` | Stores, Snippets, Transitions |
| `astro` | Islands, Content Collections, View Transitions |
| `angular` | Signals, Standalone, CDK |
| `laravel` | Blade, Livewire, Inertia, Folio |
| `html-tailwind` | Utility classes, Responsive, Dark mode |
| `shadcn` | Components, Theming, Customization |
| `swiftui` | Views, Modifiers, Navigation, State |
| `jetpack-compose` | Composables, Modifiers, Material3 |
| `react-native` | Components, Navigation, Lists |
| `flutter` | Widgets, State, Navigation, Material3 |
| `threejs` | 3D scenes, Lighting, Shaders, Animation |
...
```bash
python3 .opencode/skills/ui-ux-pro-max/scripts/search.py "search input form pattern" --stack react
```
